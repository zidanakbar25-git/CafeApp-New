    ...
    <div>
        ...
        <div class="brand-section">
            ...
            <div>
                ...
                <div class="brand-role"><?php echo e($roleLabel); ?></div>
            </div>
        </div>
        ...
        <div>
            ...
            <nav class="d-flex flex-column gap-1">
                ...
                class="nav-link-custom <?php echo e(Request::routeIs('admin.dashboard') ? 'active' : ''); ?>">
        ...
        <div>
            ...
            <nav class="d-flex flex-column gap-1">
                ...
                <a href="<?php echo e(route('admin.tables.index')); ?>"
                   class="nav-link-custom <?php echo e(Request::routeIs('admin.tables.*') ? 'active' : ''); ?>">
                    <i class="fa-regular fa-window-maximize"></i>
                    <span>Manajemen Meja</span>
                </a>

                <a href="<?php echo e(route('admin.menu.index')); ?>"
                   class="nav-link-custom <?php echo e(Request::routeIs('admin.menu.*') ? 'active' : ''); ?>">
                    <i class="fa-solid fa-utensils"></i>
                    <span>Manajemen Menu</span>
                </a>

                <a href="<?php echo e(route('admin.admins.index')); ?>"
                   class="nav-link-custom <?php echo e(Request::routeIs('admin.admins.*') ? 'active' : ''); ?>">
        ...
        <div>
            ...
            <nav class="d-flex flex-column gap-1">
                <a href="<?php echo e(route('admin.orders.history')); ?>"
                   class="nav-link-custom <?php echo e(Request::routeIs('admin.orders.history') ? 'active' : ''); ?>">
...
</aside><?php /**PATH C:\laragon\www\newCafeApp\resources\views/admin/layout/sidebar.blade.php ENDPATH**/ ?>