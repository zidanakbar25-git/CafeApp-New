...
<div class="admin-layout">
    ...
    <div class="admin-content" style="margin-left:260px;">
        ...
        <div style="padding:30px;">
            ...
            <div style="color:#6b7280;margin-bottom:28px;">Selamat Datang, <b><?php echo e(auth()->user()->username); ?></b></div>
                ...
                <div class="col-md-4">
                    <div class="stat-card d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="stat-value"><?php echo e($countAktif + $countSelesai + $countDibatalkan); ?></div>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="stat-card d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="stat-value"><?php echo e($countAktif); ?></div>
                        </div>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#9ca3af" stroke-width="1.5">
                ...
                <div class="col-md-4">
                    <div class="stat-card d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="stat-value"><?php echo e($countSelesai); ?></div>
                        </div>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#9ca3af" stroke-width="1.5">
                ...
                <div class="order-header">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        ...
                        <div class="d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <a href="<?php echo e(route('admin.dashboard', ['tab' => 'aktif', 'search' => request('search')])); ?>"
                               class="tab-btn <?php echo e($tab === 'aktif' ? 'active' : ''); ?>">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/>
                                    <rect x="9" y="3" width="6" height="4" rx="1"/>
                                </svg>
                                Aktif
                                <span class="<?php echo e($tab === 'aktif' ? 'badge bg-light text-dark' : 'badge bg-secondary'); ?>">
                                    <?php echo e($countAktif); ?>

                                </span>
                            </a>

                            <a href="<?php echo e(route('admin.dashboard', ['tab' => 'selesai', 'search' => request('search')])); ?>"
                               class="tab-btn <?php echo e($tab === 'selesai' ? 'active' : ''); ?>">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <polyline points="20 6 9 17 4 12"/>
                                </svg>
                                Selesai
                                <span class="<?php echo e($tab === 'selesai' ? 'badge bg-light text-dark' : 'badge bg-secondary'); ?>">
                                    <?php echo e($countSelesai); ?>

                                </span>
                            </a>

                            <a href="<?php echo e(route('admin.dashboard', ['tab' => 'dibatalkan', 'search' => request('search')])); ?>"
                               class="tab-btn <?php echo e($tab === 'dibatalkan' ? 'active' : ''); ?>">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <circle cx="12" cy="12" r="9"/>
                                ...
                                Dibatalkan
                                <span class="<?php echo e($tab === 'dibatalkan' ? 'badge bg-light text-dark' : 'badge bg-secondary'); ?>">
                        ...
                        <!-- Search -->
                        <form method="GET" action="<?php echo e(route('admin.dashboard')); ?>" class="d-flex gap-2">
                ...
                <div class="p-3">
                    ...
                    <?php else: ?>
                        <div class="row g-3">
                            ...
                            ?>
                            <div class="col-lg-6" id="order-card-<?php echo e($order->order_id); ?>">
                                <div class="order-card">
                                    ...
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div>
                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                <span class="order-id"><?php echo e($order->order_code); ?></span>
                                                <span class="status-badge badge-<?php echo e($order->status); ?>" id="badge-<?php echo e($order->order_id); ?>">
                                                    <?php echo e(strtoupper($order->status)); ?>

                                                </span>
                                            </div>
                                            <div class="text-secondary mt-1" style="font-size:12px;">
                                                <?php echo e($order->created_at?->setTimezone('Asia/Jakarta')->format('d M Y, H:i') ?? '-'); ?>

                                            </div>
                                        </div>
                                        <div class="text-end">
                                            <div class="info-label">Total</div>
                                            <div class="info-value">Rp <?php echo e(number_format($order->total_amount,0,',','.')); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="info-value"><?php echo e($order->cafeTable->table_number ?? '-'); ?></div>
                                        </div>
                                        <div class="col-4">
                                            <div class="info-label">Bayar</div>
                                            <div class="info-value">
                                                <?php if($bayar): ?>
                                                    <?php echo e(strtoupper($bayar)); ?>
                                    ...
                                    <div class="menu-item">
                                        <div class="d-flex justify-content-between">
                                            <span><?php echo e($detail->menu->name ?? '-'); ?> × <?php echo e($detail->quantity); ?></span>
                                    ...
                                    <?php if($order->status === 'pending_cash'): ?>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-3"
                                         id="actions-<?php echo e($order->order_id); ?>">

                                        <div class="d-flex gap-2 flex-wrap">
                                            
                                            <?php if($order->status === 'pending_cash'): ?>
                                                <button class="btn-confirm-cash"
                                                        onclick="confirmCash(<?php echo e($order->order_id); ?>, this)">
                                                    Konfirmasi Terima Uang
                                                </button>
                                                <button class="btn-cancel"
                                                        onclick="confirmCancel(<?php echo e($order->order_id); ?>)">
                                                    ✕ Batal
                                                </button>
                                            ...
                                            <?php elseif($order->status === 'menunggu'): ?>
                                                <button class="btn-serve"
                                                        onclick="updateStatus(<?php echo e($order->order_id); ?>, 'diproses', this)">
                                                    ▶ Start Serve
                                                </button>
                                                <button class="btn-cancel"
                                                        onclick="confirmCancel(<?php echo e($order->order_id); ?>)">
                                            ...
                                            <?php elseif($order->status === 'diproses'): ?>
                                                <button class="btn-done"
                                                        onclick="updateStatus(<?php echo e($order->order_id); ?>, 'selesai', this)">
                                                    ✓ Selesai
                                                </button>
                                                <button class="btn-cancel"
                                                        onclick="confirmCancel(<?php echo e($order->order_id); ?>)">
                                            ...
                                            <?php elseif($order->status === 'selesai'): ?>
                                                <button class="btn-kembali"
                                                        onclick="kembalikan(<?php echo e($order->order_id); ?>)">
                                                    ↩ Kembalikan
                                                </button>
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <?php if(in_array($order->status, ['selesai','dibatalkan'])): ?>
                                                <button class="btn-hapus"
                                                        onclick="hapusPesanan(<?php echo e($order->order_id); ?>)">
                                                    🗑
                                                </button>
                                            <?php endif; ?>
                                        </div>
...
</html><?php /**PATH C:\laragon\www\newCafeApp\resources\views/admin/cashier/dashboard/index.blade.php ENDPATH**/ ?>