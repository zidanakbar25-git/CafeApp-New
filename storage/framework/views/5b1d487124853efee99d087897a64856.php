...
<div class="admin-layout">
    ...
    <div class="admin-content">
        ...
        <div class="topbar">
            ...
            <a href="<?php echo e(route('admin.admins.index')); ?>" style="color:#6b7280;text-decoration:none;">Manajemen Admin</a>
            <span style="color:#d1d5db;">/</span>
...
unset($__errorArgs, $__bag); ?>"
                        value="<?php echo e(old('username')); ?>" placeholder="Contoh: budi123" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('admin.admins.index')); ?>" class="btn-batal">Batal</a>
                </div>
            </form>
        </div>
...
<?php /**PATH C:\laragon\www\newCafeApp\resources\views/admin/manager/management/admins/create.blade.php ENDPATH**/ ?>