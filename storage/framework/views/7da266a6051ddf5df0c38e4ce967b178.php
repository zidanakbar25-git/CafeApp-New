    ...
    <body>
                ...
                <div class="card-wrap" id="menu-card-container">
                    <div class="card-top">
                        <div>
                            ...
                            <div class="card-sub" id="menu-count-badge"><?php echo e($menus->count()); ?> menu terdaftar</div>
                        </div>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <div class="search-wrapper">
                                ...
                                <input type="text" id="ajax-search-input" class="search-input"
                                    placeholder="Cari nama menu..." value="<?php echo e(request('search')); ?>" autocomplete="off">
                            </div>
                            <a href="<?php echo e(route('admin.menu.create')); ?>" class="btn-tambah">
                        ...
                        <table class="menu-table">
                            ...
                            <tbody id="menu-table-body">
                                ...
                                <tr>
                                    ...
                                    <td class="text-secondary text-truncate" style="max-width: 200px;"><?php echo e($menu->description ?? '-'); ?></td>
                                    <td>
                                        <span class="badge-type <?php echo e($menu->category_type === 'Drink' ? 'bg-drink' : 'bg-food'); ?>">
                                            <?php echo e($menu->category_type); ?>

                                        </span>
                                    </td>

                                    
                                    <td class="text-muted"><?php echo e($menu->sub_name); ?></td>

                                    
                                    <td style="text-align:right;" class="fw-bold text-dark">Rp <?php echo e(number_format($menu->price, 0, ',', '.')); ?></td>

                                    
                                    <td style="text-align:center;">
                                        <form action="<?php echo e(route('admin.menu.toggleActive', $menu->menu_id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" class="toggle-switch <?php echo e($menu->is_active ? 'on' : ''); ?>"
                                                title="<?php echo e($menu->is_active ? 'Nonaktifkan' : 'Aktifkan'); ?> menu"
                                                onclick="event.preventDefault(); Swal.fire({title: '<?php echo e($menu->is_active ? 'Nonaktifkan' : 'Aktifkan'); ?> menu <?php echo e(addslashes($menu->name)); ?>?', icon: 'warning', showCancelButton: true, confirmButtonColor: '#451a03', confirmButtonText: 'Ya', cancelButtonText: 'Batal'}).then((result) => { if (result.isConfirmed) { this.closest('form').submit(); } })">
                                    ...
                                    <td>
                                        <div class="d-flex gap-2 justify-content-center">
                                            <a href="<?php echo e(route('admin.menu.edit', $menu->menu_id)); ?>" class="action-btn" title="Edit Menu">
        ...
        <script>
            ...
            document.getElementById('ajax-search-input').addEventListener('input', function(e) {
                ...
                fetch(`<?php echo e(route('admin.menu.index')); ?>?search=${encodeURIComponent(keyword)}`, {
                        headers: {
    ...
    </html><?php /**PATH C:\laragon\www\newCafeApp\resources\views/admin/manager/management/menu/index.blade.php ENDPATH**/ ?>