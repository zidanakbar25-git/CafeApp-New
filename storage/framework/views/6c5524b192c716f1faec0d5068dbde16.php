            ...
            <div class="card-wrap">
                <div class="card-top">
                    <div>
                        ...
                        <div class="card-sub"><?php echo e($admins->count()); ?> akun terdaftar</div>
                    </div>
                    <?php if(auth()->user()->role === 'manager'): ?>
                    <a href="<?php echo e(route('admin.admins.create')); ?>" class="btn-tambah">
                ...
                <table class="admin-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="color:#9ca3af; font-size:13px;">#<?php echo e($admin->admin_id); ?></td>
                            <td><code style="font-size:12px; color:#6b7280;"><?php echo e($admin->username); ?></code></td>
                            <td><span class="badge-role-kasir">Kasir</span></td>
                    
                            <td style="text-align:right; padding-right:24px;">
                                <div class="d-flex gap-2 justify-content-end">
                                    
                                    <a href="<?php echo e(route('admin.admins.edit', $admin->admin_id)); ?>"
                                    ...
                                    <?php if(auth()->user()->admin_id != $admin->admin_id): ?>
                                    <button class="action-btn danger" title="Hapus"
                                        data-bs-toggle="modal" data-bs-target="#deleteModal"
                                        data-id="<?php echo e($admin->admin_id); ?>"
                                        data-name="<?php echo e($admin->name ?? $admin->username); ?>">
            ...
            <div class="modal-content" style="border-radius:20px; border:none;">
                <div class="modal-body p-4 text-center">
                    ...
                    <div style="font-size:13px; color:#6b7280; margin-bottom:4px;">
                        Password baru untuk <strong><?php echo e(session('reset_name')); ?></strong>:
                    </div>
                    <div class="password-box"><?php echo e(session('new_password')); ?></div>
...
</html><?php /**PATH C:\laragon\www\newCafeApp\resources\views/admin/manager/management/admins/index.blade.php ENDPATH**/ ?>