            ...
            <div class="card-wrap">
                <div class="card-top">
                    <div>
                        ...
                        <div class="card-sub"><?php echo e($tables->count()); ?> meja terdaftar</div>
                    </div>
                    <div class="d-flex gap-3 align-items-center flex-wrap">
                        
                        <form method="GET" action="<?php echo e(route('admin.tables.index')); ?>">
                ...
                <table class="qr-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><span class="meja-number"><?php echo e($table->table_number); ?></span></td>
                            <td>
                                <a href="<?php echo e($table->qr_url); ?>" target="_blank" class="qr-url">
                                    <?php echo e($table->qr_url); ?>

                                </a>
                            </td>
                            <td style="text-align:center;">
                                <div class="qr-preview">
                                    <?php echo \SimpleSoftwareIO\QrCode\Facades\QrCode::size(60)->generate($table->qr_url); ?>
                            ...
                            <td style="text-align:right; padding-right:24px;">
                                <div class="d-flex gap-2 justify-content-end">
                                    ...
                                    <a href="<?php echo e(route('admin.tables.print', $table->table_id)); ?>"
                                    ...
                                    <form action="<?php echo e(route('admin.tables.destroy', $table->table_id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="submit" class="action-btn danger" title="Hapus Meja"
                                            onclick="event.preventDefault(); Swal.fire({title: 'Hapus meja <?php echo e($table->table_number); ?>?', text: 'Riwayat pesanan tetap tersimpan.', icon: 'warning', showCancelButton: true, confirmButtonColor: '#ef4444', confirmButtonText: 'Ya, Hapus', cancelButtonText: 'Batal'}).then((result) => { if (result.isConfirmed) { this.closest('form').submit(); } })">
...
</html><?php /**PATH C:\laragon\www\newCafeApp\resources\views/admin/manager/management/tables/index.blade.php ENDPATH**/ ?>